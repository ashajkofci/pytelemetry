...
def test_some_frames():
    ...
    # Using byte literal in a way that works in both Python 2 and 3
    frame = bytearray(b"\x03\x00cmpt\x00\xc7\x00\x00\x00\x83e")
    assert t._decode_frame(frame) == ('cmpt', 199)
